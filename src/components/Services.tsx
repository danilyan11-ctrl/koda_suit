...
export default function Services() {
  return (
    <section
      id="services"
      className="scroll-mt-28 border-b border-koda-white/10 bg-koda-black py-24 md:py-32"
    >
      <div className="container mx-auto px-4 md:px-12">
        
        <div className="mb-12 flex items-end gap-6 md:mb-20">
          <div className="font-display text-[3.5rem] leading-none text-koda-white/10 md:text-[6rem]">
            03
          </div>
        ...
        <div className="flex flex-col">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group flex cursor-pointer flex-col justify-between gap-4 border-t border-koda-white/20 py-8 transition-all duration-300 md:flex-row md:items-center md:gap-6 md:py-12 md:hover:bg-koda-white md:hover:px-8 active:bg-koda-white active:px-6"
            >
          ...
          <div className="border-t border-koda-white/20" />
        </div>
